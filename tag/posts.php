...
<?php 
    ...
    foreach($inform as $info){arms-cse3001
...
<head>
   ...
   <link rel="icon" type="image/jpg" href="https://athena-dbms.42web.io/account/img/logo.ico" />
    ...
    <style>
      ...
      @font-face {
        ...
        src: url("../../assets/fonts/icomoon/icomooarms-cse300101fc3#iefix?v=214a6e5c0e") format('embedded-opentype'),
  ...
  <body class="tag-template">arms-cse3001
