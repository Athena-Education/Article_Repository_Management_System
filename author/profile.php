...
<main class="main-wrap">
  ...
  <article class="m-article-card  post">
    ...
    <div class="m-article-card__picture">
      ...
      <a href="https://arms-cse3001.42web.io/post.php?post_link=<?=$post['id']?>" class="m-article-card__picture-link" aria-hidden="true" tabindex="-1"></a>

        <img class="m-article-card__picture-background" src="<?=$post['header']?>" onerror=this.src="../account/img/default.png" loading="lazy" alt="">

      <a href="https://arms-cse3001.42web.io/author/profile.php?encryption_id=<?=$info['username']?>" class="m-article-card__author js-tooltip" aria-label="<?=$info['author']?>" data-tippy-content="Posted by <?=$info['author']?>">
      ...
      <div class="m-article-card__info">
        ...
        <a href="https://arms-cse3001.42web.io/tag/posts.php?category_id=<?=$post['category_id']?>" class="m-article-card__tag"><?=getCategory($con, $post['category_id'])?></a>

      <a href="https://arms-cse3001.42web.io/post.php?post_link=<?=$post['id']?>" class="m-article-card__info-link" aria-label="<?=$post['title']?>">
