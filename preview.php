...
<head>
   <link rel="icon" type="image/jpg" href="https://arms-cse3001.42web.io/account/img/logo.ico" />
    ...
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
      ...
      <link rel="stylesheet" href="https://arms-cse3001.42web.io/assets/css/emoji.css" />
    ...
    if(isset($_GET['bookmark']) && isset($_GET['post_link']) && $_GET['post_link'] !='' && $_GET['bookmark'] == "true" ){
        if(isset($_SESSION['uname'])){
            ...
            echo "<script>location.href='https://arms-cse3001.42web.io/post.php?post_link=".$post."';</script>";
             ...
             echo "<script>location.href='https://arms-cse3001.42web.io/account/login.php';</script>";
        }
    }
     ...
     foreach($posts as $post){
         if(!isset($_SESSION['uname'])){
             echo "<script>location.href='https://arms-cse3001.42web.io/account/welcome/index.php';</script>";
         }
         else{
            ...
            <div class="pos-relative js-post-content">
              <div class="m-share">
                <div class="m-share__content js-sticky">
                  <a href="https://www.facebook.com/sharer/sharer.php?u=https://arms-cse3001.42web.io/post.php?post_link=<?=$post['id']?>"
                  ...
                  <a href="https://twitter.com/intent/tweet?text=<?=$post['title']?>&url=https://arms-cse3001.42web.io/post.php?post_link=<?=$post['id']?>"
...
<div class="m-subscribe-section__form">
  ...
  <article class="m-article-card  post tag">
    <div class="m-article-card__picture">
      <a href="https://arms-cse3001.42web.io/post.php?post_link=<?=$recent['id']?>" class="m-article-card__picture-link" aria-hidden="true" tabindex="-1"></a>
        <img class="m-article-card__picture-background" src="<?=$recent['header']?>" onerror=this.src='../account/img/default.png' loading="lazy" alt="">
      <a href="https://arms-cse3001.42web.io/author/profile.php?encryption_id=<?=$info['username']?>" class="m-article-card__author js-tooltip" aria-label="<?=$a['author']?>" data-tippy-content="Posted by <?=$a['author']?> ">
          <div style="background-image: url(<?=$a['photo']?>);"></div>
      </a>
    </div>
      <div class="m-article-card__info">
        <a href="https://arms-cse3001.42web.io/tag/posts.php?category_id=<?=$recent['category_id']?>" class="m-article-card__tag"><?=getCategory($con,$recent['category_id'])?></a>
      <a href="https://arms-cse3001.42web.io/post.php?post_link=<?=$recent['id']?>" class="m-article-card__info-link" aria-label="<?=$recent['title']?>">
        <div>
